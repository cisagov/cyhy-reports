...
class ScorecardGenerator(object):
    ...
    def __critical_tix_open_on_date_open_since_date_pl(
        ...
        return [
            ...
            {"$group": {"_id": {"owner": "$owner"}, "criticals_count": {"$sum": 1}}},
        ], database.TICKET_COLLECTION
    ...
    def __critical_tix_open_on_date_open_since_date_for_orgs_pl(
        ...
        return [
            ...
            {"$group": {"_id": {"owner": parent_org}, "criticals_count": {"$sum": 1}}},
        ], database.TICKET_COLLECTION
    ...
    def __run_queries(self):
        ...
        for r in requests_with_descendants:
            ...
            pipeline_collection = (
                self.__open_critical_tix_opened_in_date_range_for_orgs_pl(
            ...
            pipeline_collection = (
                self.__critical_tix_open_on_date_open_since_date_for_orgs_pl(
